      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          ...
          <motion.p
            ...
            className="mt-6 text-lg text-voltcraft-gray-400 max-w-3xl mx-auto"
          >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-20">
          <motion.div
            ...
            viewport={{ once: true }}
            className="p-8 bg-voltcraft-dark rounded-2xl border border-voltcraft-gray-800"
          >
            ...
            <p className="text-voltcraft-gray-400 leading-relaxed">
        ...
        <div className="mb-20">
          ...
          >
            <div className="bg-voltcraft-dark rounded-xl p-8 md:p-12">
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                <div>
                  ...
                  <p className="text-voltcraft-gray-400 mb-8 leading-relaxed">
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    {printerSpecs.map((spec) => (
                      <div key={spec.label} className="p-3 bg-voltcraft-gray-900/50 rounded-lg">
                        <p className="text-sm text-voltcraft-gray-500">{spec.label}</p>
                ...
                <div className="relative">
                  <div className="aspect-square rounded-2xl bg-voltcraft-gray-900 flex items-center justify-center overflow-hidden">
                    <div className="text-center p-8">
                      <Box className="w-32 h-32 text-voltcraft-primary mx-auto mb-4 animate-float" />
                      <p className="text-voltcraft-gray-400">Bambu Lab A1 Combo</p>
                      <p className="text-sm text-voltcraft-gray-500">High-speed, multi-color 3D printer</p>
                    </div>
                  </div>
                  ...
                  <div className="absolute -right-4 top-8 glass rounded-xl p-3">
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-sm text-white">Multi-Color</span>
                    </div>
                  </div>
                  <div className="absolute -left-4 bottom-8 glass rounded-xl p-3">
                    <div className="flex items-center gap-2">
                      <Zap className="w-5 h-5 text-yellow-500" />
                      <span className="text-sm text-white">500mm/s Speed</span>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {services.map((service, index) => (
              <motion.div
                ...
                className="p-6 bg-voltcraft-dark rounded-2xl border border-voltcraft-gray-800 hover:border-voltcraft-gray-700 transition-colors"
              >
                ...
                <p className="text-voltcraft-gray-400 text-sm">{service.description}</p>
              </motion.div>
            ))}
          </div>
        </div>
              ...
              >
                <div className="flex flex-col items-center">
                  ...
                  {index < timeline.length - 1 && (
                    <div className="w-0.5 h-full bg-voltcraft-gray-800 mt-2" />
                  )}
                </div>
                <div className="flex-1 pb-8">
                  <span className="text-voltcraft-primary font-semibold">{item.year}</span>
                  <p className="text-voltcraft-gray-300 mt-1">{item.event}</p>
                </div>
              </motion.div>
            ))}
          </div>
        ...
        >
          <div className="p-8 md:p-12 bg-voltcraft-dark rounded-2xl border border-voltcraft-gray-800">
            <h2 className="text-2xl md:text-3xl font-display font-bold text-white mb-4">
              Ready to start your project?
            </h2>
            <p className="text-voltcraft-gray-400 mb-8 max-w-xl mx-auto">
