  ...
  return (
    ...
    >
      ...
      <div className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-voltcraft-primary/20 to-voltcraft-secondary/20 p-1">
        ...
        <div className="relative bg-voltcraft-dark rounded-xl p-6 md:p-8">
          <div className="flex items-center justify-between mb-6">
            <h3 className="text-xl font-display font-bold text-white">Your Quote</h3>
          ...
          {/* Total Price */}
          <div className="text-center py-8 border-y border-voltcraft-gray-800">
            <p className="text-voltcraft-gray-400 text-sm mb-2">Estimated Total</p>
            <motion.div
              key={quote.totalCost}
            ...
            <p className="text-voltcraft-gray-400 text-sm mt-2">
          ...
          <div className="grid grid-cols-2 gap-4 mt-6">
            <div className="p-4 bg-voltcraft-gray-900/50 rounded-xl">
              <div className="flex items-center gap-2 text-voltcraft-gray-400 text-sm mb-1">
      ...
      <div className="grid grid-cols-2 gap-3">
        <motion.div
          ...
          className="p-3 sm:p-4 bg-voltcraft-dark rounded-xl border border-voltcraft-gray-800"
        >
          <div className="flex items-center gap-2 text-voltcraft-gray-400 text-xs sm:text-sm mb-2">
      ...
      {/* Model Info */}
      <div className="p-4 bg-voltcraft-dark rounded-xl border border-voltcraft-gray-800">
        <h4 className="text-sm font-medium text-voltcraft-gray-400 mb-3 flex items-center gap-2">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-sm">
          ...
          <div>
            ...
            <p className="text-white font-medium">{material.shortName}</p>
          </div>
          <div>
            <span className="text-voltcraft-gray-500">Layer Height</span>
            <p className="text-white font-medium">{settings.layerHeight}mm</p>
          </div>
          <div>
            <span className="text-voltcraft-gray-500">Infill</span>
            <p className="text-white font-medium">{settings.infillPercentage}%</p>
          </div>
        </div>
        
        <div className="mt-3 pt-3 border-t border-voltcraft-gray-800">
          <span className="text-voltcraft-gray-500 text-sm">Dimensions: </span>
      ...
      <button
        ...
        className="w-full mt-2 px-6 py-3 bg-green-600 hover:bg-green-700 rounded-xl font-semibold text-white transition-colors flex items-center justify-center gap-2"
      >
