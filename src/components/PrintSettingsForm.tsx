    ...
    <div className="space-y-6">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-2">
          {layerHeightOptions.map((option) => (
            ...
            >
              ...
              <div className="text-xs text-voltcraft-gray-400 mt-0.5">{option.value}mm</div>
            </motion.button>
          ))}
        </div>
      </div>
      ...
      <div className="space-y-3">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-2">
          {infillPresets.map((option) => (
            ...
            >
              <div className="font-medium text-white text-sm">{option.label}</div>
              <div className="text-xs text-voltcraft-gray-400 mt-0.5">{option.value}%</div>
            </motion.button>
          ))}
        </div>
        ...
        <div className="pt-2">
          <input
            ...
            className="w-full h-2 bg-voltcraft-gray-800 rounded-lg appearance-none cursor-pointer accent-voltcraft-primary"
          />
          <div className="flex justify-between text-xs text-voltcraft-gray-500 mt-1">
            <span>5%</span>
      ...
      <div className="space-y-3">
        ...
        <div className="flex gap-3">
          ...
          >
            <div className="font-medium text-white">No Support</div>
            <div className="text-xs text-voltcraft-gray-400 mt-1">
          ...
          >
            <div className="font-medium text-white">With Support</div>
            <div className="text-xs text-voltcraft-gray-400 mt-1">
      ...
      <div className="space-y-3">
        ...
        <div className="flex items-center gap-4">
          <motion.button
            ...
            whileHover={{ scale: 1.05 }}
            whileTap={{ scale: 0.95 }}
            className="w-12 h-12 rounded-lg bg-voltcraft-dark border-2 border-voltcraft-gray-800 hover:border-voltcraft-gray-600 flex items-center justify-center text-white text-xl font-bold"
          >
            -
          </motion.button>
          ...
          <input
            ...
            className="w-20 h-12 bg-voltcraft-dark border-2 border-voltcraft-gray-800 rounded-lg text-center text-white text-lg font-semibold focus:outline-none focus:border-voltcraft-primary"
          />
